            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right button-btn-gradient" style="text-decoration : none; color : #FFFFFF; ">{{ __('Confirm Password') }}</label>
